      ...
      <Transition.Root>
        ...
        >
          ...
          >
            ...
            <MobileNavLink href="/#policy">Policy</MobileNavLink>
            <MobileNavLink href="/#specialists">Specialists</MobileNavLink>
          </Popover.Panel>
        </Transition.Child>
      </Transition.Root>
    </Popover>
...
export function Header() {
  return (
    <header className="py-10 fixed top-0 w-full z-50 bg-transparent">  {/* Changed to fixed, removed shadow-md, and added w-full */}
      <Container>
